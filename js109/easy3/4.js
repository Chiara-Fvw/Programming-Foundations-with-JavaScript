...
P:
find the first number of the serie that has n digits.
Data
...
loop while fibonacci,length - 1 === elem.length === num
fibonacci.push(fibonacci[idx - 1], fibonacci[idx] )
1, 1, 2, 3, 5, 8...

return ribonacci.length + 'n'
*/
